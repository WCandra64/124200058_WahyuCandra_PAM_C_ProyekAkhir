...
import 'package:proyek_akhir/home_page.dart';
...
class VillainPage extends StatefulWidget {
  const VillainPage({Key? key}) : super(key: key);

  @override
  _VillainPageState createState() => _VillainPageState();
}
    ...
    return MaterialApp(
        ...
        home: Scaffold(
          ...
          body: Container(
            ...
            child: FutureBuilder(
              future: DataSource.instance.loadVillains(),
